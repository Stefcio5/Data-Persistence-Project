...
public class HighscoreTable : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        SortHighscoreEntryList(highscores);
        RemoveLastEntry(highscores);
    ...
    private static void RemoveLastEntry(Highscores highscores)
    {
    ...
    private void CreateHighscoreEntryTransform(HighscoreEntry highscoreEntry, Transform container, List<Transform> transformList)
    {
        ...
        entryRectTransform.anchoredPosition = new Vector2(55, -templateHeight * transformList.Count);
